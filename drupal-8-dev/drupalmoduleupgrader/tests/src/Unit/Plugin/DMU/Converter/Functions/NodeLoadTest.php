...
use Drupal\drupalmoduleupgrader\Plugin\DMU\Converter\Functions\NodeLoad;
 ...
 */
class NodeLoadTest extends FunctionCallModifierTest {

  public function setUp() {
    parent::setUp();
    $this->plugin = NodeLoad::create($this->container, [], 'node_load', []);
  }
