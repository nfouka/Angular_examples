...
use Drupal\drupalmoduleupgrader\Plugin\DMU\Converter\Functions\DB;
 ...
 */
class DBTest extends FunctionCallModifierTest {

  public function setUp() {
    parent::setUp();
    $this->plugin = DB::create($this->container, [], '_db:db_select', ['function' => 'db_select']);
  }
