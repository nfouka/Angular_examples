...
use Drupal\drupalmoduleupgrader\Plugin\DMU\Converter\Functions\CommentLoad;
 ...
 */
class CommentLoadTest extends FunctionCallModifierTest {

  public function setUp() {
    parent::setUp();
    $this->plugin = CommentLoad::create($this->container, [], 'comment_load', []);
  }
