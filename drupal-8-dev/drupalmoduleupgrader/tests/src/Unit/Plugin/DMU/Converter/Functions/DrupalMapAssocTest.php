...
use Drupal\drupalmoduleupgrader\Plugin\DMU\Converter\Functions\DrupalMapAssoc;
 ...
 */
class DrupalMapAssocTest extends FunctionCallModifierTest {

  public function setUp() {
    parent::setUp();
    $this->plugin = DrupalMapAssoc::create($this->container, [], 'drupal_map_assoc', []);
  }
