...
use Drupal\drupalmoduleupgrader\Plugin\DMU\Converter\Functions\UserLoad;
 ...
 */
class UserLoadTest extends FunctionCallModifierTest {

  public function setUp() {
    parent::setUp();
    $this->plugin = UserLoad::create($this->container, [], 'user_load', []);
  }
