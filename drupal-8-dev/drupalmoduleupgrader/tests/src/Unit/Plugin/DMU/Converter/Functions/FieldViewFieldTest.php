...
use Drupal\drupalmoduleupgrader\Plugin\DMU\Converter\Functions\FieldViewField;
 ...
 */
class FieldViewFieldTest extends FunctionCallModifierTest {

  public function setUp() {
    parent::setUp();
    $this->plugin = FieldViewField::create($this->container, [], 'field_view_field', []);
  }
