...
use Drupal\drupalmoduleupgrader\Plugin\DMU\Converter\Functions\VariableGet;
 ...
 */
class VariableGetTest extends FunctionCallModifierTest {

  public function setUp() {
    parent::setUp();
    $this->plugin = VariableGet::create($this->container, [], 'variable_get', []);
  }
