...
use Drupal\drupalmoduleupgrader\Plugin\DMU\Converter\Functions\VariableDel;
 ...
 */
class VariableDelTest extends FunctionCallModifierTest {

  public function setUp() {
    parent::setUp();
    $this->plugin = VariableDel::create($this->container, [], 'variable_del', []);
  }
