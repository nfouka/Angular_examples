...
use Drupal\drupalmoduleupgrader\Plugin\DMU\Converter\Functions\VariableSet;
 ...
 */
class VariableSetTest extends FunctionCallModifierTest {

  public function setUp() {
    parent::setUp();
    $this->plugin = VariableSet::create($this->container, [], 'variable_set', []);
  }
...
END;
  ...
  public function testStringKey() {
    ...
    $this->assertEquals('\Drupal::config(\'foo.settings\')->set("foo_wambooli", 30)->save()', $rewritten->getText());
  }
