...
use Drupal\drupalmoduleupgrader\Plugin\DMU\Converter\Functions\CacheSet;
 ...
 */
class CacheSetTest extends FunctionCallModifierTest {

  public function setUp() {
    parent::setUp();
    $this->plugin = CacheSet::create($this->container, [], 'cache_set', []);
  }
