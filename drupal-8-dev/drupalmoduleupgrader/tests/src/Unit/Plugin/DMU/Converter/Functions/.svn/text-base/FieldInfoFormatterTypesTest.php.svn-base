...
use Drupal\drupalmoduleupgrader\Plugin\DMU\Converter\Functions\FieldInfoFormatterTypes;
 ...
 */
class FieldInfoFormatterTypesTest extends FunctionCallModifierTest {

  public function setUp() {
    parent::setUp();
    $this->plugin = FieldInfoFormatterTypes::create($this->container, [], 'field_info_formatter_types', []);
  }
