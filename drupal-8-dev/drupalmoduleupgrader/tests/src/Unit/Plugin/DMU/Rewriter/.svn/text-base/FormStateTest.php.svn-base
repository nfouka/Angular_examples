...
use Drupal\drupalmoduleupgrader\Plugin\DMU\Rewriter\FormState;
...
class FormStateTest extends UnitTestCase {
  ...
  public function setUp() {
    ...
    $this->plugin = new FormState([], 'form_state', $definition, $translator, $this->getMock('\Psr\Log\LoggerInterface'));
  }
